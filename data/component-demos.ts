export const componentDemos: Record<string, string> = {
  ...
  'data-table': '<table class="data-table" aria-label="Data table"><thead class="data-table-head"><tr class="data-table-row"><th class="data-table-col">Name</th><th class="data-table-col">Value</th></tr></thead><tbody class="data-table-body"><tr class="data-table-row"><td class="data-table-td">Item 1</td><td class="data-table-td">100</td></tr></tbody></table>',
  ...
  'kanban-table': '<table class="kanban-table" aria-label="Kanban board"><thead class="kanban-table-head"><tr class="kanban-table-row"><th class="kanban-table-col">To Do</th><th class="kanban-table-col">In Progress</th><th class="kanban-table-col">Done</th></tr></thead><tbody class="kanban-table-body"><tr class="kanban-table-row"><td class="kanban-table-td">Task 1</td><td class="kanban-table-td">Task 2</td><td class="kanban-table-td">Task 3</td></tr></tbody></table>',
