...
- 490 headless Vue components with `<script setup lang="ts">` syntax
...
- 1342 tests across 490 test files
...
| `/components`           | Lists all 490 components with links to individual demos |
...
- **Component styles**: All 490 component CSS classes with NHS-appropriate styling
...
- [Vue Headless](../lily-design-system-vue-headless/) — 490 headless Vue components
