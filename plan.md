# Lily Design System — Vue Nuxt.js Examples — Implementation Plan

## Goal

Create styled example pages demonstrating component usage with Nuxt 3 + Vue 3 with simple styling. Examples use NHS UK design system CSS for visual styling on top of headless components.

## Technology

- Framework: Nuxt 3 + Vue 3 with simple styling
...
- [x] /components route lists all 364 components
